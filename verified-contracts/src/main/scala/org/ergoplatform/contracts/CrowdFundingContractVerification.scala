...
sealed abstract class CrowdFundingContract extends SigmaContract {
  ...
  def crowdFundingContract(
    deadline: Int,
    minToRaise: Long,
    pkBacker: SigmaProp,
    pkProject: SigmaProp
  )(ctx: Context): SigmaProp = {
    import ctx._
...
case object CrowdFundingContractVerification extends CrowdFundingContract {
  ...
  def proveBackerGetsAfterDeadLine(
    ctx: Context,
    deadline: Int,
    minToRaise: Long,
    pkBacker: SigmaProp,
  ...
  def proveBackerDeniedBeforeDeadLine(
    ctx: Context,
    deadline: Int,
    minToRaise: Long,
    pkBacker: SigmaProp,
  ...
  def proveProjectGetsIfEnoughRaisedBeforeDeadline(
    ctx: Context,
    deadline: Int,
    minToRaise: Long,
    pkBacker: SigmaProp,
  ...
  def proveProjectDeniedIfEnoughRaisedButAfterDeadline(
    ctx: Context,
    deadline: Int,
    minToRaise: Long,
    pkBacker: SigmaProp,
